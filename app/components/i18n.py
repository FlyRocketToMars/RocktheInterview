...
TRANSLATIONS = {
    "zh": {
        ...
        "auth_success_register_verify": "注册成功！请检查邮箱验证。",
    ...
    "en": {
        ...
        "auth_success_register_verify": "Registration successful! Please check your email.",
